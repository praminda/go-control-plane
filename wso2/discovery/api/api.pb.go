...
type Api struct {
	...
	VendorExtensible map[string]*anypb.Any `protobuf:"bytes,10,rep,name=vendorExtensible,proto3" json:"vendorExtensible,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *Api) GetVendorExtensible() map[string]*anypb.Any {
	if x != nil {
